...
const ARTICLES = [
  {
    ...
    title: "Meilleur ostéopathe dans la Drôme (26) : top 10 en 2026",
    excerpt:
      "Valence, Montélimar, Romans, Nyons, Pierrelatte… Les 10 meilleurs ostéopathes du département sélectionnés pour vous.",
    icon: (
