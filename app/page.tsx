...
const IconBack = () => (
	<svg
		className="w-8 h-8 text-sage shrink-0"
		fill="none"
		stroke="currentColor"
		viewBox="0 0 24 24"
		aria-hidden
...
const IconBus = () => (
	...
	>
		<path
			...
			strokeLinejoin="round"
			strokeWidth={1.5}
			d="M8 7v8m8-8v8m-8-4h8M4 7h16M4 17h16"
		/>
	</svg>
);
const IconLightbulb = () => (
...
const AVANTAGES = [
	{
		title: "Deux cabinets à votre service",
		text: "Consultations à Valence (rue du Lycée) et à Saint Lattier (allée du Cultil), pour votre commodité.",
		Icon: IconBuilding,
	},
	{
		title: "Techniques douces et non invasives",
		text: "Approche adaptée à chaque patient, du nourrisson au senior.",
		Icon: IconHeart,
	},
	{
		title: "Prise de RDV facile",
		text: "Réservation en ligne 24h/24 via Doctolib, sans attente.",
		Icon: IconClock,
	},
	{
		title: "Remboursé par les mutuelles",
		text: "Plus de 85 % des mutuelles prennent en charge l'ostéopathie.",
		Icon: IconShield,
	},
];
...
const TARIFS = [
	{
		title: "Consultation — toutes séances",
		price: "60€",
		duration: "durée : 1h",
		note: "",
	},
	{
		title: "Enfant jusqu'à 3 ans",
		price: "45€",
		duration: "durée : 1h",
		note: "",
	},
	{
		title: "À domicile",
		price: "75€ – 90€",
		duration: "selon déplacement",
		note: "📞 RDV uniquement par téléphone",
	},
];
...
const TEMOIGNAGES = [
	{
		name: "Marie L.",
		motif: "Douleurs dorsales chroniques",
		text: "Après des mois de douleurs, j'ai retrouvé un vrai confort. L'approche est douce et professionnelle. Je recommande vivement.",
		stars: 5,
	},
	{
		name: "Thomas D.",
		motif: "Suivi pendant la grossesse de ma compagne",
		text: "Accompagnement parfait pendant toute la grossesse. Elle a pu aborder l'accouchement plus sereinement. Merci !",
		stars: 5,
	},
	{
		name: "Sophie M.",
		motif: "Coliques de bébé",
		text: "Notre petit avait des coliques difficiles. En quelques séances, nous avons vu une vraie amélioration. Ostéopathe à l'écoute et rassurant.",
		stars: 5,
	},
	{
		name: "Pierre F.",
		motif: "Blessure au genou (sport)",
		text: "Reprise du running après une entorse. Bilan et soins adaptés, je suis revenu progressivement sans douleur. Top.",
		stars: 5,
	},
];
...
export const FAQ_ITEMS = [
	{
		...
		a: "L'ostéopathie n'est pas remboursée par l'Assurance Maladie. Plus de 85 % des mutuelles prennent en charge les séances (forfait variable). Une facture vous est délivrée à chaque consultation pour votre demande de remboursement.",
	},
	{
		q: "Combien de séances sont nécessaires ?",
		a: "Cela dépend du motif et de votre historique. Souvent 1 à 3 séances suffisent pour un motif aigu. Pour un suivi chronique ou en prévention, nous en discutons au premier rendez-vous.",
	},
	{
		q: "Faut-il une ordonnance pour consulter un ostéopathe ?",
		a: "Non. Vous pouvez consulter en direct, sans ordonnance. En cas de pathologie connue ou de traitement en cours, il est conseillé d'en informer votre ostéopathe et votre médecin.",
	},
	{
		q: "L'ostéopathie est-elle douloureuse ?",
		a: "Les techniques sont adaptées à chaque patient et généralement douces. Certaines manipulations peuvent provoquer un inconfort passager. Votre ressenti est pris en compte et les techniques sont ajustées si besoin.",
	},
	{
		q: "À partir de quel âge peut-on consulter un ostéopathe ?",
		a: "Dès la naissance. L'ostéopathie pour nourrissons est courante (coliques, torticolis, plagiocéphalie). Les techniques sont adaptées à l'âge, du bébé au senior.",
	},
	{
		q: "Comment se déroule une première séance ?",
		a: "La première séance comprend un interrogatoire (motif, antécédents), un examen clinique puis un traitement adapté. Prévoyez environ 45 minutes pour un adulte. Apportez vos examens médicaux pertinents si vous en avez.",
	},
	{
		q: "Quand consulter un ostéopathe ?",
		a: "Douleurs vertébrales ou articulaires, après un choc ou une chute, suivi de grossesse, nourrisson (coliques, torticolis, sommeil), prévention (sport, stress, travail sédentaire) ou après un accouchement. En cas de doute, contactez-nous.",
	},
	{
		q: "Quelle est la différence entre un ostéopathe et un kinésithérapeute ?",
		a: "L'ostéopathe travaille sur l'ensemble du corps (articulations, muscles, viscères, crâne) pour rétablir la mobilité. Le kiné se concentre sur la rééducation motrice, souvent sur prescription. Les deux approches sont complémentaires.",
	},
];
	...
	return (
		<div className="min-h-screen bg-offwhite text-foreground">
			<script
				...
				dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchemaGlobal) }}
			/>
			<a
			...
			<main id="contenu-principal">
				<ScrollAnimations>
					...
					<SectionReveal className="relative py-20 md:py-28 px-4 md:px-8 bg-offwhite overflow-hidden">
						<div
							className="absolute top-0 right-0 w-96 h-96 bg-sage/30 blur-3xl opacity-30 rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none z-0"
							aria-hidden
						/>
						<div className="relative z-10 mx-auto max-w-4xl">
							<h2 className="text-3xl font-light text-gray-800 md:text-4xl text-center">
								Pauline Odeyer, Ostéopathe D.O. — Une Approche Globale de Votre
								Santé
							</h2>
							<div
								className="w-16 h-1 bg-gold mx-auto mt-4 rounded-full"
								aria-hidden
							/>
							<div className="mt-10 space-y-6 text-gray-600 leading-relaxed text-center">
								<p>
									Ostéopathe D.O. diplômée, Pauline Odeyer exerce au{" "}
									<strong>9 rue du Lycée à Valence (26000)</strong> et au{" "}
									<strong>55 allée du Cultil à Saint Lattier (38840)</strong>.
									Elle propose des consultations d&apos;ostéopathie adaptées à
									chaque patient, reposant sur des techniques manuelles douces
									et non invasives, pour traiter les douleurs
									musculo-squelettiques, les troubles fonctionnels et
									accompagner toute la famille — du nourrisson au senior — vers
									un meilleur équilibre corporel.
								</p>
								<p>
									Chaque consultation débute par un bilan complet — écoute de
									vos antécédents, examen postural et palpation — avant un
									traitement personnalisé. L&apos;objectif : identifier
									l&apos;origine de vos douleurs et restaurer la mobilité de vos
									tissus pour un soulagement durable.
								</p>
							</div>
						</div>
					</SectionReveal>
					...
					<section className="py-16 md:py-24 px-4 md:px-8 bg-offwhite">
						<div className="mx-auto max-w-6xl">
							...
							<div
								className="w-16 h-1 bg-gold mx-auto mt-4 mb-10 rounded-full"
								aria-hidden
							/>
							<Script
					...
					<SectionReveal
						id="services"
						className="relative py-20 md:py-28 px-4 md:px-8 bg-cream/50 overflow-hidden"
					>
						<div
							className="absolute bottom-0 left-0 w-[28rem] h-[28rem] bg-cream blur-3xl opacity-40 rounded-full translate-y-1/2 -translate-x-1/2 pointer-events-none z-0"
							aria-hidden
						/>
						<div className="relative z-10 mx-auto max-w-6xl">
							...
							<div
								className="w-16 h-1 bg-gold mx-auto mt-4 mb-6 rounded-full"
								aria-hidden
							/>
							<p className="text-center text-gray-600 max-w-2xl mx-auto mb-14">
								Des soins adaptés à chaque âge et chaque besoin : de l&apos;
								<Link
									href="/osteopathe-dos"
									className="text-sage font-medium underline decoration-sage/40 underline-offset-2 hover:decoration-sage"
								>
									ostéopathie pour adultes et douleurs du dos
								</Link>{" "}
							...
							>
								{SERVICES.map(({ title, desc, Icon, href }) => {
									...
									const cardClass =
										"card-3d card-shadow rounded-2xl bg-white p-8 border border-bluegray/20";
									return href ? (
										<Link
											key={title}
											href={href}
											className={`block ${cardClass} transition hover:no-underline`}
										>
											{cardContent}
										</Link>
									) : (
					...
					<SectionReveal className="py-20 md:py-28 px-4 md:px-8 bg-offwhite">
						<div className="mx-auto max-w-6xl">
							...
							<div
								className="w-16 h-1 bg-gold mx-auto mt-4 mb-14 rounded-full"
								aria-hidden
							/>
							<div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
								{AVANTAGES.map(({ title, text, Icon }) => (
									...
									>
										<div className="avantage-icon-wrap mb-4">
											<Icon />
										</div>
										<h3 className="text-lg font-semibold text-gray-800">
											{title}
					...
					<SectionReveal className="py-20 md:py-28 px-4 md:px-8 bg-offwhite">
						<div className="mx-auto max-w-4xl">
							...
							<div
								className="w-16 h-1 bg-gold mx-auto mt-4 mb-12 rounded-full"
								aria-hidden
							/>
							<div className="space-y-10 text-gray-600 leading-relaxed">
								<div className="flex gap-4">
									...
									<div>
										...
										<p>
											Lombalgies, cervicalgies, torticolis, hernies discales ou
											douleurs entre les omoplates sont des motifs fréquents de
											consultation. Lorsque la douleur persiste plus de trois
											jours, revient régulièrement ou limite vos mouvements au
											quotidien,{" "}
											<Link
												href="/osteopathe-dos"
												className="text-sage font-medium underline decoration-sage/40 underline-offset-2 hover:decoration-sage"
											>
												consulter un ostéopathe pour le dos
											</Link>{" "}
											permet d&apos;en identifier l&apos;origine et de soulager
											les tensions par des techniques adaptées. Une prise en
											charge précoce évite souvent l&apos;installation de
											douleurs chroniques.
										</p>
									</div>
								</div>
								<div className="flex gap-4">
									...
									<div>
										...
										<p>
											Chutes, accidents de la route, faux mouvements ou whiplash
											(coup du lapin) peuvent créer des blocages et des
											déséquilibres dans tout le corps. L&apos;ostéopathe
											travaille à rééquilibrer les tensions post-traumatiques, à
											libérer les articulations et les tissus pour favoriser une
											récupération complète et limiter les séquelles à long
											terme.
										</p>
									</div>
								</div>
								<div className="flex gap-4">
									...
									<div>
										<h3 className="text-xl font-semibold text-gray-800 mb-2">
											Troubles fonctionnels récurrents
										</h3>
										<p>
											Migraines, vertiges, troubles digestifs, insomnies ou
											stress chronique ont souvent une composante mécanique ou
											posturale. L&apos;ostéopathie ne se contente pas de
											traiter les symptômes : elle cherche la cause (tensions
											crâniennes, blocages vertébraux, déséquilibres viscéraux)
											pour apporter un soulagement durable et améliorer votre
											qualité de vie.
										</p>
									</div>
								</div>
								<div className="flex gap-4">
									...
									<div>
										...
										<p>
											Une consultation préventive deux à trois fois par an est
											idéale pour maintenir un bon équilibre corporel. Elle est
											...
											, aux travailleurs sédentaires, aux{" "}
											<Link
												href="/osteopathe-senior"
												className="text-sage font-medium underline decoration-sage/40 underline-offset-2 hover:decoration-sage"
											>
											...
											ou à toute personne souhaitant prévenir l&apos;apparition
											de douleurs. L&apos;ostéopathe repère et corrige les
											petites dysfonctions avant qu&apos;elles ne deviennent
											gênantes.
										</p>
									</div>
								</div>
					...
					<SectionReveal className="py-20 md:py-28 px-4 md:px-8 bg-cream/50">
						<div className="mx-auto max-w-4xl">
							...
							<div
								...
								aria-hidden
							/>
							<p className="text-center text-gray-600 mb-12 mt-6">
								Prévoyez environ 45 minutes pour une première consultation.
							</p>
							<div className="relative">
								<div
									className="absolute left-6 top-0 bottom-0 w-0.5 bg-sage/40 md:left-1/2 md:-translate-x-px"
									aria-hidden
								/>
									...
									{[
										{
											...
											title: "Anamnèse",
											Icon: IconClipboard,
											text: "Votre ostéopathe vous interroge sur vos antécédents, votre motif de consultation et votre mode de vie. Cette phase d'écoute est essentielle pour comprendre l'origine de vos douleurs.",
										},
										{
											step: 2,
											title: "Examen clinique",
											Icon: IconSearch,
											text: "Tests de mobilité, palpation et observation posturale permettent d'identifier les zones de restriction et de tension dans votre corps.",
										},
										{
											step: 3,
											title: "Traitement",
											Icon: IconHand,
											text: "Des techniques manuelles douces — articulaires, musculaires, crâniennes ou viscérales — sont appliquées pour restaurer la mobilité et soulager vos douleurs.",
										},
										{
											step: 4,
											title: "Conseils personnalisés",
											Icon: IconLightbulb,
											text: "En fin de séance, votre ostéopathe vous donne des recommandations : exercices, postures à adopter, délai avant la prochaine séance si nécessaire.",
										},
									].map((item) => (
										<div
											key={item.step}
											className="relative flex gap-6 md:odd:flex-row md:even:flex-row-reverse md:mb-12 last:mb-0"
										>
											<div className="flex shrink-0 items-center justify-center w-12 h-12 rounded-full bg-sage text-white font-semibold text-lg z-10">
												{item.step}
											</div>
					...
					<SectionReveal className="py-20 md:py-28 px-4 md:px-8 bg-offwhite">
						<div className="mx-auto max-w-4xl">
							<h2 className="text-3xl font-light text-gray-800 md:text-4xl text-center mb-4">
								Remboursement Ostéopathie : Quelle Prise en Charge par les
								Mutuelles ?
							</h2>
							<div
								className="w-16 h-1 bg-gold mx-auto mt-4 rounded-full"
							...
							<p className="text-center text-gray-600 leading-relaxed mb-10">
								...
								l&apos;Assurance Maladie (Sécurité Sociale). Cependant, plus de
								85 % des complémentaires santé prennent en charge les
								consultations d&apos;ostéopathie, à hauteur de 1 à 4 séances par
								an selon votre contrat.
							</p>
							<div className="space-y-8 text-gray-600">
								<div>
									...
									<ol className="list-decimal list-inside space-y-2">
										...
										<li>
											Recevez votre facture à la fin de la séance (elle est
											délivrée systématiquement).
										</li>
										<li>
											Envoyez la facture à votre mutuelle (en ligne ou par
											courrier) ; elle procède au remboursement selon votre
											forfait.
										</li>
									</ol>
								</div>
								<div>
									...
									<p className="mb-4">
										La plupart des grandes mutuelles françaises prennent en
										charge l&apos;ostéopathie : Harmonie Mutuelle, MGEN,
										Malakoff Humanis, AG2R La Mondiale, Allianz, AXA, Swiss
										Life, entre autres. Le montant du remboursement varie de 25€
										à 80€ par séance selon votre contrat.
									</p>
										...
										<table className="w-full text-sm text-left">
											<thead>
												<tr className="bg-cream/80 border-b border-gold/30">
													...
													<th className="px-4 py-3 font-semibold text-gray-800">
														Remboursement moyen / séance
													</th>
												</tr>
											</thead>
											<tbody className="bg-white">
												<tr className="border-b border-bluegray/20">
													<td className="px-4 py-3">Harmonie Mutuelle</td>
													<td className="px-4 py-3">40€ - 60€</td>
												</tr>
												<tr className="border-b border-bluegray/20">
													<td className="px-4 py-3">MGEN</td>
													<td className="px-4 py-3">50€ - 70€</td>
												</tr>
												<tr className="border-b border-bluegray/20">
													<td className="px-4 py-3">Malakoff Humanis</td>
													<td className="px-4 py-3">30€ - 60€</td>
												</tr>
												<tr className="border-b border-bluegray/20">
													<td className="px-4 py-3">AG2R La Mondiale</td>
													<td className="px-4 py-3">40€ - 80€</td>
												</tr>
												<tr>
													<td className="px-4 py-3">AXA / Allianz</td>
									...
									<p className="mt-4 text-sm text-gray-600 italic">
										Astuce : Vérifiez votre contrat ou appelez votre mutuelle
										pour connaître votre niveau de prise en charge. Nous
										délivrons une facture conforme à chaque consultation.
									</p>
								</div>
							</div>
						</div>
					...
					>
						<div
							className="absolute top-1/2 left-0 w-80 h-80 bg-gold/10 blur-3xl rounded-full -translate-x-1/2 pointer-events-none z-0"
							aria-hidden
						/>
						<div className="relative z-10 mx-auto max-w-4xl">
							<h2 className="text-3xl font-light text-gray-800 md:text-4xl text-center mb-4">
							...
							<p className="text-center text-gray-600 mb-4 max-w-2xl mx-auto mt-6">
								Facture délivrée à chaque consultation pour le remboursement par
								votre mutuelle. Plus de 85 % des complémentaires santé prennent
								en charge les séances d&apos;ostéopathie (1 à 4 séances par an
								selon votre contrat).
							</p>
							<div className="grid gap-6 md:grid-cols-3 mt-8">
								{TARIFS.map(({ title, price, duration, note }) => (
									...
									>
										...
										<p className="mt-4 text-5xl font-light text-gold">
											{price}
										</p>
										<p className="mt-2 text-sm text-gray-500">{duration}</p>
										{note && (
											<p className="mt-3 text-xs font-medium text-sage bg-sage/10 rounded-full px-3 py-1">
												{note}
											</p>
										)}
									</div>
									...
									>
										<div className="testimonial-stars flex gap-1 mb-3">
											{Array.from({ length: t.stars }).map((_, i) => (
												<span key={i} className="testimonial-star inline-block">
													<IconStar />
												</span>
											))}
										</div>
					...
					<SectionReveal
						id="quartiers"
						className="py-20 md:py-28 px-4 md:px-8 bg-cream/50"
					>
						<div className="mx-auto max-w-4xl">
							<h2 className="text-3xl font-light text-gray-800 md:text-4xl text-center mb-4">
							...
							<div
								className="w-16 h-1 bg-gold mx-auto mt-4 mb-8 rounded-full"
								aria-hidden
							/>
							<div
							...
							<p className="text-center text-gray-600 max-w-2xl mx-auto text-sm leading-relaxed">
								Pauline Odeyer reçoit ses patients à Valence (Drôme) et à Saint
								Lattier (Isère). Que vous veniez de Valence, Romans-sur-Isère,
								Saint-Marcellin ou des environs, l&apos;un des deux cabinets est
					...
					<SectionReveal
						id="contact"
						className="py-20 md:py-28 px-4 md:px-8 bg-offwhite"
					>
						<div className="mx-auto max-w-2xl">
							...
							<p className="text-center text-gray-600 mb-6 mt-6">
								Réservez directement en ligne via Doctolib, ou utilisez le
								formulaire ci-dessous pour toute question.
							</p>
					...
					{/* Accès & plan */}
					<section
						className="py-20 md:py-28 px-4 md:px-8 bg-bluegray/10"
									...
									<div className="flex flex-col gap-4">
										<div className="rounded-xl bg-white p-5 card-shadow border border-bluegray/20 flex items-start gap-4">
											...
											<div>
												<p className="font-semibold text-gray-800">Adresse</p>
												<p className="text-gray-600 text-sm mt-0.5">
													55 allée du Cultil, 38840 Saint Lattier
												</p>
											</div>
										</div>
										<div className="rounded-xl bg-white p-5 card-shadow border border-bluegray/20 flex items-start gap-4">
